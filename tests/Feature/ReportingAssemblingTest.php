...
class ReportingAssemblingTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        Schema::create('trstockdt', function ($table) {
            ...
            $table->string('fcode')->nullable(); // 'B' or 'J'
            $table->decimal('fqty', 15, 2)->default(0);
            $table->decimal('fqtyremain', 15, 2)->nullable();
            $table->decimal('fhpp', 15, 2)->default(0);
    ...
    public function test_reporting_assembling_displays_branches()
    {
        $user = Sysuser::create([
            'fsysuserid' => 'admin',
            'fname' => 'Administrator',
        ...
        $response = $this->actingAs($user, 'sysuser')
            ->get(route('reportingassembling.index'));
    ...
    public function test_reporting_assembling_index_with_filter()
    {
        $user = Sysuser::create([
            'fsysuserid' => 'admin',
            'fname' => 'Administrator',
