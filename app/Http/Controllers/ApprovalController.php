...
class ApprovalController extends Controller
{
    public function showApprovalPage(Request $request, ?string $fprno = null)
    {
        ...
        if (! $hdr) {
            return redirect()->route('tr_prh.index')->with('error', 'Permintaan Pembelian tidak ditemukan.');
        }
        $dt = Tr_prd::query()
    ...
    public function showApprovalPagePO(Request $request, ?string $fpono = null)
    {
        ...
        if (! $hdr) {
            return redirect()->route('login')->with('error', 'Permintaan Pembelian tidak ditemukan.');
        }
