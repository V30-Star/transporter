...
class ReportingProductController extends Controller
{
  ...
  public function exportExcel(Request $request)
  {
    ...
    if ($showCols['hpp'])    $headers[] = 'HPP';
    if ($showCols['price1']) $headers[] = 'Harga Jual 1';
    if ($showCols['price2']) $headers[] = 'Harga Jual 2';
    if ($showCols['price3']) $headers[] = 'Harga Jual 3';
    ...
    foreach ($data as $i => $row) {
      ...
      if ($showCols['hpp'])    $cols[] = (float) $row->fhpp;
      if ($showCols['price1']) $cols[] = (float) $row->fhargajuallevel1;
      if ($showCols['price2']) $cols[] = (float) $row->fhargajuallevel2;
      if ($showCols['price3']) $cols[] = (float) $row->fhargajuallevel3;
