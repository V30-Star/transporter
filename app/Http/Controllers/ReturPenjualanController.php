        ...
        return response()->json([
            ...
            'items' => $items->map(function ($item) use ($header) {
                ...
                return [
                    ...
                    'fqtyremain' => (float) (isset($item->fqtyremain) && $item->fqtyremain !== null && (float)$item->fqtyremain > 0 ? $item->fqtyremain : ($item->fqty ?? 0)),
                    'maxqty' => (float) (isset($item->fqtyremain) && $item->fqtyremain !== null && (float)$item->fqtyremain > 0 ? $item->fqtyremain : ($item->fqty ?? 0)),
        ...
        try {
            ...
            DB::transaction(function () use (
                ...
                $headerData = [
                    ...
                    'fwhcode' => mb_substr((string) ($request->ffrom ?? $request->fwhcode ?? ''), 0, 10),
                    'fcurrency' => $fcurrency,
                    'frate' => $frate,
                    'fdiscount' => $totalDisc,
        ...
        try {
            DB::transaction(function () use (
                ...
                DB::table('log_tranmt')->insert([
                    ...
                    'fwhcode'          => $updatedHeader->fwhcode ?? $updatedHeader->ffrom ?? null,
        ...
        try {
            ...
            DB::transaction(function () use ($ftranmtid, &$deletedHeader, $userIdLog) {
                ...
                DB::table('log_tranmt')->insert([
                    ...
                    'fwhcode'          => $returpenjualan->fwhcode ?? $returpenjualan->ffrom ?? null,
