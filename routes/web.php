...
use App\Http\Controllers\ReportingRekapPenjualanSalesCustomerController;
use App\Http\Controllers\ReportingRekapPenjualanSalesProdukController;
...
Route::middleware(['auth', EnsureRoutePermission::class])->group(function () {
    ...
    Route::prefix('master')->group(function () {
        ...
        Route::get('/fakturpembelian/product-history', [FakturpembelianController::class, 'productHistory'])->name('fakturpembelian.product-history');
        ...
        Route::get('/returpembelian/product-history', [ReturPembelianController::class, 'productHistory'])
            ->name('returpembelian.product-history');
        ...
        Route::get('/reportingrekappenjualansalesproduk', [ReportingRekapPenjualanSalesProdukController::class, 'index'])->name('reportingrekappenjualansalesproduk.index');
        Route::get('/reportingrekappenjualansalesproduk/print', [ReportingRekapPenjualanSalesProdukController::class, 'print'])->name('reportingrekappenjualansalesproduk.print');
        Route::get('/reportingrekappenjualansalesproduk/excel', [ReportingRekapPenjualanSalesProdukController::class, 'exportExcel'])->name('reportingrekappenjualansalesproduk.excel');
        ...
        Route::get('/trialbalance', [TrialBalanceController::class, 'index'])->name('trialbalance.index');
        Route::get('/trialbalance/print', [TrialBalanceController::class, 'print'])->name('trialbalance.print');
        Route::get('/trialbalance/excel', [TrialBalanceController::class, 'exportExcel'])->name('trialbalance.excel');
        ...
        Route::get('/reportingpelunasansupplier', [ReportingPelunasanSupplierController::class, 'index'])->name('reportingpelunasansupplier.index');
        Route::get('/reportingpelunasansupplier/print', [ReportingPelunasanSupplierController::class, 'print'])->name('reportingpelunasansupplier.print');
        Route::get('/reportingpelunasansupplier/exportExcel', [ReportingPelunasanSupplierController::class, 'exportExcel'])->name('reportingpelunasansupplier.exportExcel');
