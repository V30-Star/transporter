...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1800px] w-full mx-auto">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <ul class="mt-2 text-sm text-red-600 list-disc list-inside space-y-1">
                            <li>Salesman sudah direferensi di customer</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated:
                {{ $salesman->fupdatedat ? \Carbon\Carbon::parse($salesman->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($salesman->fcreatedat)->format('d M Y, H:i') }}
            </p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-gray-700 mb-4">
                        Apakah Anda yakin ingin menghapus salesman <strong
                            class="text-gray-900">{{ $salesman->fsalesmancode }} -
                            {{ $salesman->fsalesmanname }}</strong>?
                    </p>
