    ...
    <div x-data="{ open: true }">
        <div x-data="{ includePPN: false, ppnRate: 0, ppnAmount: 0, selected: 'alamatsurat', totalHarga: 100000 }" class="lg:col-span-5">
            <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1600px] w-full mx-auto">
                <form action="{{ route('salesorder.update', $salesorder->ftrsomtid) }}" method="POST" class="mt-6" x-data="{ showNoItems: false }"
                    @submit.prevent="
      ...
      ">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                        ...
                        <div class="lg:col-span-4" x-data="{ autoCode: false }">
                            ...
                            <p x-show="autoCode" class="text-[10px] text-blue-600 mt-1">* Nomor akan digenerate otomatis
                                saat simpan</p>
                        </div>
                        ...
                        <div class="lg:col-span-4">
                            ...
                            <div class="flex">
                                ...
                                <input type="hidden" name="fcustno" id="customerCodeHidden" value="{{ old('fcustno', $salesorder->fcustno) }}">
                                <button type="button"
                    ...
                    <div x-data="itemsTable()" x-init="init()" class="mt-6 space-y-2">
                        ...
                        <div class="overflow-auto border rounded">
                            <table class="min-w-full text-sm">
                                ...
                                <tbody>
                                    <template x-for="(it, i) in savedItems" :key="String(it.uid)"> <!-- ROW UTAMA -->
