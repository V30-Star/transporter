...
<head>
    ...
    <style>
        * {
        ...
        .po-header {
            display: grid;
            grid-template-columns: 12mm 28mm 20mm 24mm 1fr 24mm 14mm;
            gap: 1px;
            font-size: 8.5px;
            padding: 2px 6px;
            align-items: center;
        ...
        .po-detail {
            display: grid;
            grid-template-columns: 25mm 1fr 16mm 24mm 18mm 20mm 22mm;
            gap: 1px;
            font-size: 8px;
            padding: 2px 6px;
            align-items: center;
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Penerimaan Barang</div>
                </div>
            </div>
        ...
        @foreach ($groupedData as $fstockmtno => $details)
            @php
                $h = $details->first();
                $grandTotalHarga += (float) $h->famountmt;
                $viewUrl = route('penerimaanbarang.view', $h->fstockmtid);
                $editUrl = route('penerimaanbarang.edit', $h->fstockmtid);
            @endphp
        ...
        <div class="po-totals-panel-wrapper">
            ...
            <div class="po-totals-container">
                <div class="po-total-row grand-total-row">
                    <span>GRAND TOTAL NILAI PENERIMAAN</span>
                    <span>Rp {{ number_format((float) $grandTotalHarga, 2, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
