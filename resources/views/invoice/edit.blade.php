                        ...
                        <div x-data="{ autoCode: false }">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="text" name="fsono"
                                    ...
                                    class="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm uppercase bg-gray-100 text-gray-500 cursor-not-allowed border-gray-200"
                                    readonly>
                    ...
                    <div class="p-4 flex items-center justify-end gap-3">
                            ...
                            @elseif ($action === 'view')
                                <a href="{{ route('invoice.print', $invoice->fsono) }}" target="_blank"
                                    class="inline-flex h-9 items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 text-xs font-semibold text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
