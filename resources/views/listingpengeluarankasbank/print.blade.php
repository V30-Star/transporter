...
<body>
    ...
    <div class="no-print">
        ...
        <a href="{{ route('listingpengeluarankasbank.excel', request()->query()) }}"
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Pengeluaran Kas/Bank</div>
                </div>
            </div>
        ...
        @foreach ($grouped as $items)
            @php
                $h = $items->first();
                $viewUrl = route('pengeluarankas.view', $h->fkasmtno);
                $editUrl = route('pengeluarankas.edit', $h->fkasmtno);
            @endphp
