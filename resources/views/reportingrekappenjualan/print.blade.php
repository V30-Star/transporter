...
<head>
    ...
    <style>
        * {
        ...
        /* --- TABLE STYLES (5 Kolom) --- */
        .po-header-labels,
        .item-row,
        .group-total-row {
            display: grid;
            grid-template-columns: 8mm 26mm 1fr 28mm 32mm;
            gap: 1px;
            font-size: 8.5px;
            padding: 2px 6px;
            align-items: center;
...
<body>
    ...
    <div class="no-print">
        ...
        <a href="{{ route('reportingrekappenjualan.excel', request()->query()) }}"
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Laporan Rekap Penjualan</div>
                </div>
            </div>
        ...
        @forelse ($rows->groupBy('fmerek') as $groupCode => $items)
            ...
            <div class="journal-block group-row">
                {{ $groupByText }}: {{ $groupCode }} - {{ $groupName }}
            </div>
