            ...
            <form action="{{ route('tr_prh.store') }}" method="POST">
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <br?>
                        ...
                        <!-- Komponen Alpine: sinkron kode/nama & isi satuan -->
                        <!-- Komponen Alpine: sinkron kode/nama, isi satuan, dan batasi qty -->
                        <script>
                            function detailProduk() {
                                return {
                                    ...
                                    onProductChange(row, code) {
                                        ...
                                        // clamp qty: 1..maxqty (maxqty=0 -> kosong)
                                        if (row.maxqty > 0) {
