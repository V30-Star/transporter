...
@section('content')
    <div x-data="{
        ...
        {{--  Search & Filter Form  --}}
        <form method="GET" action="{{ route('tr_prh.index') }}"
        ...
        <div class="mt-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-sm">Page {{ $tr_prh->currentPage() }} of {{ $tr_prh->lastPage() }}</span>
                <button class="px-3 py-1 rounded border hover:bg-gray-100" {{ $tr_prh->hasMorePages() ? '' : 'disabled' }}>
                    &rarr;
                </button>
            </div>
        </div>
