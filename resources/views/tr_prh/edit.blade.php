                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <div x-data="{ autoCode: true }">
                                    <label class="block text-xs font-bold mb-1">
                                        PR# <span class="text-red-500" x-show="!autoCode">*</span>
                                    </label>
                                    <div class="flex items-center gap-2">
                                        <input type="text" name="fprno"
                                            ...
                                            value="{{ strtoupper(old('fprno', $tr_prh->fprno ?? '')) }}"
                                            :disabled="autoCode"
                                            :required="!autoCode"
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
                        ...
                        <div class="flex items-center justify-end gap-3 px-4 py-3 bg-gray-50 border-t border-gray-200">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if ($isView && $canPrint)
                                    @php
                                        $isApproved = (int) ($tr_prh->fapproval ?? 0) === 1;
                                        $isPrinted = ! can_print_again() && (int) ($tr_prh->fprint ?? 0) === 1;
                                    @endphp
                                    @if (!$isApproved)
                                        <button type="button"
                                            onclick="Swal.fire({ icon: 'warning', title: 'Informasi', text: 'Permintaan Pembelian belum di-approve dan tidak boleh dicetak.', confirmButtonColor: '#3b82f6' })"
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <div x-data="{
                                    ...
                                    supplierDisplay: '{{ $tr_prh->fsuppliername }} ({{ $tr_prh->fsuppliercode }})'
                                }"
                            ...
                            <div class="space-y-2">
                                ...
                                <div x-show="showDescModal" x-cloak
                                    ...
                                    <div class="relative bg-white w-[92vw] max-w-lg rounded-2xl shadow-2xl overflow-hidden"
                                        ...
                                        <div class="px-5 py-2 border-t flex items-center justify-end gap-2 bg-gray-50">
                                            <button type="button" @click="closeDesc()"
                                                class="h-9 px-4 rounded-lg bg-white border border-gray-300 text-gray-700 text-sm font-medium hover:bg-gray-50 transition-colors">
                                                Tutup
                                            </button>
