...
@section('content')
    <div x-data="{
        ...
        {{--  Search & Filter Form  --}}
        <form method="GET" action="{{ route('merek.index') }}"
                ...
                @forelse($mereks as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border px-2 py-1 space-x-2">
                            ...
                            <button @click="openDelete('{{ route('merek.destroy', $item->fmerekid) }}')"
        ...
        <div class="mt-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-sm">Page {{ $mereks->currentPage() }} of {{ $mereks->lastPage() }}</span>
                <button class="px-3 py-1 rounded border hover:bg-gray-100" {{ $mereks->hasMorePages() ? '' : 'disabled' }}>
                    &rarr;
                </button>
            </div>
        </div>
