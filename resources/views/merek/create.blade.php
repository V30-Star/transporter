...
@section('title', 'New - Master Merek')
...
<div>
    ...
    <div class="max-w-4xl mx-auto py-8 px-6">
        ...
        <form action="{{ route('merek.store') }}" method="POST" id="formMerek">
            @csrf
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="fmerekcode" id="fmerekcode"
                                ...
                                maxlength="10" placeholder="cth. MRK-001" autofocus>
                            @error('fmerekcode')
                        ...
                        <div>
                            ...
                            <input type="text" name="fmerekname" id="fmerekname"
                                ...
                                maxlength="50" placeholder="cth. Coca-Cola">
                            @error('fmerekname')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div x-data="{ active: {{ old('fnonactive') == '1' ? 'false' : 'true' }} }">
                        <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-gray-50 cursor-pointer hover:border-gray-300 transition-colors"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400 mt-0.5">Non-aktif menyembunyikan merek dari transaksi baru</p>
                            </div>
