        ...
        <div class="bg-white rounded shadow p-6 md:p-8 max-w-[700px] mx-auto">
            <form action="{{ route('merek.store') }}" method="POST">
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="fmerekname" value="{{ old('fmerekname') }}"
                            class="w-full border rounded px-3 py-2 @error('fmerekname') border-red-500 @enderror" autofocus>
                        @error('fmerekname')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6 flex justify-center space-x-4">
                    ...
                    <!-- Keluar -->
                    <button type="button" @click="window.location.href='{{ route('merek.index') }}'"
