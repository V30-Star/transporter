                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <select name="fhargalevel" id="fhargalevel"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100">
                                    <option value="0"
                                        {{ old('fhargalevel', $customer->fhargalevel) == 0 ? 'selected' : '' }}>Harga Level
                                        1</option>
                                    <option value="1"
                                        {{ old('fhargalevel', $customer->fhargalevel) == 1 ? 'selected' : '' }}>Harga Level
                                        2</option>
                                    <option value="2"
                                        {{ old('fhargalevel', $customer->fhargalevel) == 2 ? 'selected' : '' }}>Harga Level
                                        3</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="fnpwp" id="fnpwp"
                            ...
                            <div>
                                ...
                                <input type="text" name="fkodefp" id="fkodefp"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="fnik" id="fnik"
                            ...
                            <div>
                                ...
                                <input type="text" name="fnamaktp" id="fnamaktp"
                                    value="{{ old('fnamaktp', $customer->fnamaktp) }}"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 uppercase @error('fnamaktp') border-red-400 @enderror"
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="ftelp" id="ftelp"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="fkontakperson" id="fkontakperson"
                            ...
                            <div>
                                ...
                                <input type="text" name="fjabatan" id="fjabatan"
                        ...
                        <div class="mt-4 border border-gray-200 rounded-lg p-3 bg-gray-50/50">
                            ...
                            <div class="flex space-x-1.5 mb-3">
                                <button type="button" @click="selectedAlamat = 'alamatsurat'"
                                    :class="selectedAlamat === 'alamatsurat' ?
                                ...
                                <button type="button" @click="selectedAlamat = 'alamatkirim'"
                                    :class="selectedAlamat === 'alamatkirim' ?
                                        'bg-blue-600 text-white border-blue-600 shadow-sm' :
                                        'bg-white text-gray-600 hover:bg-gray-50 border-gray-200'"
                                    class="px-3 py-1.5 rounded-lg border text-xs font-medium transition-colors">
                                    Alamat Kirim
                                ...
                                <button type="button" @click="selectedAlamat = 'alamatpajak'"
                                    :class="selectedAlamat === 'alamatpajak' ?
                                        'bg-blue-600 text-white border-blue-600 shadow-sm' :
                                        'bg-white text-gray-600 hover:bg-gray-50 border-gray-200'"
                                    class="px-3 py-1.5 rounded-lg border text-xs font-medium transition-colors">
                                    Alamat Pajak
                            ...
                            <div x-show="selectedAlamat === 'alamatsurat'" class="space-y-2">
                                <textarea name="faddress" id="faddress" rows="3"
                                    ...
                                    placeholder="Masukkan Alamat Surat">{{ old('faddress', $customer->faddress) }}</textarea>
                            </div>

                            <div x-show="selectedAlamat === 'alamatkirim'" class="space-y-2">
                                <textarea name="fkirimaddress1" id="fkirimaddress1" rows="2"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                    placeholder="Masukkan Alamat Kirim 1">{{ old('fkirimaddress1', $customer->fkirimaddress1) }}</textarea>
                                <textarea name="fkirimaddress2" id="fkirimaddress2" rows="2"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                    placeholder="Masukkan Alamat Kirim 2">{{ old('fkirimaddress2', $customer->fkirimaddress2) }}</textarea>
                                <textarea name="fkirimaddress3" id="fkirimaddress3" rows="2"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                    placeholder="Masukkan Alamat Kirim 3">{{ old('fkirimaddress3', $customer->fkirimaddress3) }}</textarea>
                            </div>

                            <div x-show="selectedAlamat === 'alamatpajak'" class="space-y-2">
                                <textarea name="ftaxaddress" id="ftaxaddress" rows="3"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                    placeholder="Masukkan Alamat Pajak">{{ old('ftaxaddress', $customer->ftaxaddress) }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <input type="number" name="ftempo" id="ftempo"
                                    value="{{ old('ftempo', $customer->ftempo) }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="fmaxtempo" id="fmaxtempo"
                                    value="{{ old('fmaxtempo', $customer->fmaxtempo) }}"
                                    {{ $allowEditAdmin ? '' : 'readonly disabled' }}
                            ...
                            <div>
                                ...
                                <input type="text" name="flimit" id="flimit"
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="fmemo" id="fmemo" rows="3"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                placeholder="Masukkan Memo">{{ old('fmemo', $customer->fmemo) }}</textarea>
                        </div>

                        {{-- Toggles --}}
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {{-- Status Blokir --}}
                            <div x-data="{ blocked: {{ old('fblokir', $customer->fblokir) == '1' ? 'true' : 'false' }} }">
                                <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-gray-50 cursor-pointer hover:border-gray-300 transition-colors"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400 mt-0.5">Mencegah customer dari membuat transaksi
                                            baru</p>
                                    </div>
                            ...
                            {{-- Status Aktif --}}
                            <div x-data="{ active: {{ old('fnonactive', $customer->fnonactive) == '1' ? 'false' : 'true' }} }">
                                <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-gray-50 cursor-pointer hover:border-gray-300 transition-colors"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400 mt-0.5">Non-aktif menyembunyikan customer dari
                                            daftar aktif</p>
                                    </div>
                                    <div class="relative w-9 h-5 rounded-full transition-colors duration-200 flex-shrink-0"
