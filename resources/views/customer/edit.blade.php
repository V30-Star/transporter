                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex-1">
                                ...
                                <input type="text" name="fcustomercode" id="fcustomercode"
                                    ...
                                    :class="(autoCode || {{ !empty($isTransactionLocked) ? 'true' : 'false' }}) ? 'bg-gray-100 text-gray-500 cursor-not-allowed border-gray-200' : 'bg-white'">
                            ...
                            <label class="inline-flex items-center mt-5 font-medium text-xs text-gray-700 cursor-pointer {{ !empty($isTransactionLocked) ? 'opacity-50 cursor-not-allowed' : '' }}">
                        ...
                        <div>
                            ...
                            <select name="fgroup" id="groupSelect" class="w-full">
                                ...
                                @foreach ($groups as $group)
                                    <option value="{{ $group->fgroupid }}" {{ old('fgroup', $customer->fgroup) == $group->fgroupid ? 'selected' : '' }}>
                                        {{ $group->fgroupname }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="fsalesman" id="salesmanSelect" class="w-full">
                                ...
                                @foreach ($salesman as $sales)
                                    <option value="{{ $sales->fsalesmancode }}" {{ old('fsalesman', $customer->fsalesman) == $sales->fsalesmancode ? 'selected' : '' }}>
                                        {{ $sales->fsalesmanname }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="fwilayah" id="wilayahSelect" class="w-full">
                                ...
                                @foreach ($wilayah as $wil)
                                    <option value="{{ $wil->fwilayahid }}" {{ old('fwilayah', $customer->fwilayah) == $wil->fwilayahid ? 'selected' : '' }}>
                                        {{ $wil->fwilayahname }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="fnpwp" id="fnpwp" value="{{ old('fnpwp', $customer->fnpwp) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="fnik" id="fnik" value="{{ old('fnik', $customer->fnik) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="fkodefp" id="fkodefp" value="{{ old('fkodefp', $customer->fkodefp) }}" maxlength="3"
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="ftelp" id="ftelp" value="{{ old('ftelp', $customer->ftelp) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="ffax" id="ffax" value="{{ old('ffax', $customer->ffax) }}"
                        ...
                        <div>
                            ...
                            <input type="email" name="femail" id="femail" value="{{ old('femail', $customer->femail) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="fkontakperson" id="fkontakperson" value="{{ old('fkontakperson', $customer->fkontakperson) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="fjabatan" id="fjabatan" value="{{ old('fjabatan', $customer->fjabatan) }}"
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="ftempo" id="ftempo" value="{{ old('ftempo', $customer->ftempo) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="fmaxtempo" id="fmaxtempo" value="{{ old('fmaxtempo', $customer->fmaxtempo) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="flimit" id="flimit" value="{{ old('flimit', $customer->flimit) }}"
                    ...
                    <div>
                        ...
                        <select name="frekening" id="frekening" class="w-full">
                            ...
                            @foreach ($rekening as $rek)
                                <option value="{{ $rek->frekeningid }}" {{ old('frekening', $customer->frekening) == $rek->frekeningid ? 'selected' : '' }}>
                                    {{ $rek->frekeningname }}
                                </option>
                            @endforeach
                        </select>
