...
@section('title', 'Master Customer - Tambah')
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex-1">
                                    ...
                                    <input type="text" name="fcustomercode" id="fcustomercode"
                                        ...
                                        :class="autoCode ? 'bg-gray-100 text-gray-500 cursor-not-allowed border-gray-200' :
                                            'bg-white'">
                                </div>
                                <label
                                    class="inline-flex items-center mt-5 font-medium text-xs text-gray-700 cursor-pointer">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <select name="fhargalevel" id="fhargalevel"
                                    ...
                                    <option value="0" {{ old('fhargalevel', 0) == 0 ? 'selected' : '' }}>Harga Level 1
                                    </option>
                                    <option value="1" {{ old('fhargalevel') == 1 ? 'selected' : '' }}>Harga Level 2
                                    </option>
                                    <option value="2" {{ old('fhargalevel') == 2 ? 'selected' : '' }}>Harga Level 3
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="fkodefp" id="fkodefp" value="{{ old('fkodefp', '010') }}"
                                    maxlength="3"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="fnamaktp" id="fnamaktp" value="{{ old('fnamaktp') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <select name="fjadwaltukarfakturmingguan" id="fjadwaltukarfakturmingguan"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100">
                                    <option value="1"
                                        {{ old('fjadwaltukarfakturmingguan') == '1' ? 'selected' : '' }}>Setiap Minggu
                                    </option>
                                    <option value="2"
                                        {{ old('fjadwaltukarfakturmingguan') == '2' ? 'selected' : '' }}>Minggu Ganjil
                                    </option>
                                    <option value="3"
                                        {{ old('fjadwaltukarfakturmingguan') == '3' ? 'selected' : '' }}>Minggu Genap
                                    </option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="fjadwaltukarfakturhari" id="fjadwaltukarfakturhari"
                                    ...
                                    <option value="1" {{ old('fjadwaltukarfakturhari') == '1' ? 'selected' : '' }}>
                                        Senin</option>
                                    <option value="2" {{ old('fjadwaltukarfakturhari') == '2' ? 'selected' : '' }}>
                                        Selasa</option>
                                    <option value="3" {{ old('fjadwaltukarfakturhari') == '3' ? 'selected' : '' }}>
                                        Rabu</option>
                                    <option value="4" {{ old('fjadwaltukarfakturhari') == '4' ? 'selected' : '' }}>
                                        Kamis</option>
                                    <option value="5" {{ old('fjadwaltukarfakturhari') == '5' ? 'selected' : '' }}>
                                        Jumat</option>
                                    <option value="6" {{ old('fjadwaltukarfakturhari') == '6' ? 'selected' : '' }}>
                                        Sabtu</option>
                                    <option value="7" {{ old('fjadwaltukarfakturhari') == '7' ? 'selected' : '' }}>
                                        Minggu</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <select name="frekening" id="frekening" class="w-full">
                                ...
                                @foreach ($rekening as $rek)
                                    <option value="{{ $rek->frekeningid }}"
                                        {{ old('frekening') == $rek->frekeningid ? 'selected' : '' }}>
                                        {{ $rek->frekeningname }}
                                    </option>
                                @endforeach
                            </select>
