...
<head>
    <meta charset="utf-8">
    <title>Bayar Supplier - {{ $hdr->fkasmtno ?? '-' }}</title>
    ...
    <div id="raw-templates" style="display: none;">
        ...
        <div id="tpl-header">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">BAYAR SUPPLIER</div>
        ...
        <table id="tpl-table">
            <thead id="tpl-thead">
                <tr>
                    ...
                    <th class="text-right" style="width: 68px;">Sisa Hutang</th>
            ...
            <tbody id="raw-rows">
                @forelse ($dt as $i => $row)
                    ...
                    {{-- Row 2: Nilai Order, Sisa Hutang, Disc, Nilai Bayar --}}
        ...
        <div id="tpl-header">
            <div class="header-row">
                ...
                <div style="min-width: 260px;">
                    <div class="doc-title">{{ 'Bayar Supplier' }}</div>
