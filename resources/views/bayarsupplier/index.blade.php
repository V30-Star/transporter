                    ...
                    <tr data-filter-year="{{ \Carbon\Carbon::parse($record->fkasmtdate)->format('Y') }}"
                        ...
                        <td class="border px-2 py-2 text-right whitespace-nowrap">
                            <div class="flex items-center justify-end gap-1.5 flex-nowrap">
                                <a href="{{ route('bayarsupplier.view', $record->fkasmtno) }}"
...
@push('styles')
    ...
    <style>
        ...
        #bayarSupplierTable td {
            vertical-align: middle;
        }

        #bayarSupplierTable th:last-child,
        #bayarSupplierTable td:last-child {
            text-align: right;
            white-space: nowrap;
        }
    ...
    <script>
        $(function() {
            ...
            const dateFilter = function(settings, data, dataIndex) {
                if (settings.nTable.id !== 'bayarSupplierTable') {
                    return true;
                }
            ...
            const table = $('#bayarSupplierTable').DataTable({
                pageLength: 10,
                ...
                initComplete: function() {
                    const wrapper = document.querySelector('#bayarSupplierTable_wrapper .dt-search');
