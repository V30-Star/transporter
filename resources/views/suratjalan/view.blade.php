...
@section('content')
    @php
        ...
        $canPrint = in_array('viewTr_prh', $permissions, true) || in_array('updateSuratJalan', $permissions, true) || in_array('deleteSuratJalan', $permissions, true) || in_array('createSuratJalan', $permissions, true);
    @endphp
    <style>
        input:focus,
        select:focus,
