        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full p-6">
                <div class="flex justify-between items-center border-b pb-4 mb-4">
                    <h3 class="text-xl font-bold text-gray-800">Listing PR</h3>
                    <button onclick="toggleModal(false)"
                        class="text-gray-400 hover:text-gray-600 text-2xl font-bold">&times;</button>
                </div>

                <form method="GET" action="{{ route('listingpr.print') }}" target="_blank">
                    <div class="space-y-4">
                        {{-- Cabang checkboxes --}}
                        <div>
                        ...
                        <div>
                            ...
                            <select name="sort_by" class="w-full border rounded px-3 py-2 text-sm">
                                ...
                                <option value="name">Tanggal PR</option>
                            </select>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-2 bg-gray-50 p-3 rounded border">
                            <label class="flex items-center text-sm font-semibold">
                                <input type="checkbox" name="all_pr" id="all_pr" checked class="mr-2 w-4 h-4"> Semua PR
                            </label>
                            <label class="flex items-center text-sm font-semibold">
                                <input type="checkbox" name="only_pending" id="only_pending" class="mr-2 w-4 h-4"> Hanya PR
                                Belum Diorder Semua
                            </label>
                        </div>
                    </div>
