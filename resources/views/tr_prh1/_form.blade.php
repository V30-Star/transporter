...
@if ($routeName === 'tr_prh.create')
    @include('components.transaction.tr-prh-shared', ['section' => 'form_styles'])
...
@push('styles')
    @include('components.transaction.tr-prh-shared', ['section' => 'datatables_length_styles'])
    @include('components.transaction.datatables-styles')
@endpush

{{-- DATA & SCRIPTS --}}
<script>
    @include('components.transaction.tr-prh-shared', ['section' => 'browser_globals'])

    // ── Pure DOM helpers untuk draft unit select ──────────────────────────────
    @include('components.transaction.tr-prh-shared', ['section' => 'draft_unit_dom_helpers'])

    // ── supplierBrowser ───────────────────────────────────────────────────────
    @include('components.transaction.tr-prh-shared', ['section' => 'supplier_browser_standard'])
    ...
    function itemsTable() {
        ...
        return {
            ...
            @include('components.transaction.tr-prh-shared', ['section' => 'items_noacak_methods'])

            @include('components.transaction.tr-prh-shared', ['section' => 'items_product_meta_rich_methods'])
            ...
            @include('components.transaction.tr-prh-shared', ['section' => 'items_desc_basic_methods'])

            @include('components.transaction.tr-prh-shared', ['section' => 'items_enforce_qty_method'])
...
@push('scripts')
    ...
    <script>
        @include('components.transaction.tr-prh-shared', ['section' => 'product_browser_standard'])
    </script>
@endpush
@endif
...
@if (in_array($routeName, ['tr_prh.edit', 'tr_prh.delete'], true))
    @include('components.transaction.tr-prh-shared', ['section' => 'form_styles'])
    @include('components.transaction.error-alert', ['title' => 'Gagal Memperbarui Data!'])
    @php
    ...
    <script>
        ...
        function itemsTable() {
            ...
            return {
                ...
                @include('components.transaction.tr-prh-shared', ['section' => 'items_noacak_methods'])
                @include('components.transaction.tr-prh-shared', ['section' => 'items_format_qty_method'])
                onCodeTypedDraft() {
...
@php
    ...
    <div x-data="{ open: true }">
        ...
        @push('styles')
            @include('components.transaction.datatables-styles')
        @endpush
        @include('components.transaction.tr-prh-datatables-length-styles')
        {{-- DATA & SCRIPTS --}}
        <script>
            @include('components.transaction.tr-prh-shared', ['section' => 'browser_globals', 'includeInitItems' => true])

            // Modal supplier (sama dengan create)
            @include('components.transaction.tr-prh-shared', ['section' => 'supplier_browser_standard'])

            // Alpine store untuk desc (optional, sama seperti create)
            @include('components.transaction.tr-prh-shared', ['section' => 'desc_store'])
            ...
            function itemsTable() {
                return {
                    ...
                    @include('components.transaction.tr-prh-shared', ['section' => 'items_sanitize_number_method'])
                    @include('components.transaction.tr-prh-shared', ['section' => 'items_format_qty_method'])
                    enforceQtyRow(row) {
                    ...
                    @include('components.transaction.tr-prh-shared', ['section' => 'items_desc_preview_methods'])
        ...
        @push('scripts')
            ...
            <script>
                ...
                @include('components.transaction.tr-prh-shared', ['section' => 'product_browser_standard', 'includeForEdit' => true])
