...
@section('title', $action === 'delete' ? 'Hapus Jurnal Faktur Pembelian' : 'Edit Jurnal Faktur Pembelian')
...
@section('content')
    ...
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[96rem] mx-auto"
        x-data="journalForm({
            ...
            deleteUrl: @js(route('jurnalpembelian.destroy', $jurnaltransaksi->fjurnalmtid)),
            indexUrl: @js(route('jurnalpembelian.index')),
        ...
        @if ($isDelete)
            <div class="space-y-6">
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <a href="{{ route('jurnalpembelian.index') }}"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <input type="text" value="{{ old('fjurnaltype', $jurnaltransaksi->fjurnaltype) }}"
                            class="w-full border rounded px-3 py-2 bg-gray-100 cursor-not-allowed" disabled>
                        <select name="fjurnaltype_display" class="hidden" disabled>
        ...
        @if ($isDelete)
            ...
            <form action="{{ route('jurnalpembelian.destroy', $jurnaltransaksi->fjurnalmtid) }}" method="POST"
