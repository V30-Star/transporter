...
@section('title', 'Jurnal Faktur Pembelian')
            ...
            <form action="{{ route('jurnalpembelian.store') }}" method="POST" data-form-draft="true"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <input type="text" value="{{ $fixedJournalType ?? 'JBL' }}"
                        ...
                        <input type="hidden" name="fjurnaltype" value="{{ $fixedJournalType ?? 'JBL' }}">
                    </div>
                ...
                <div class="mt-8 flex justify-center gap-4">
                    ...
                    <button type="button" onclick="window.location='{{ route('jurnalpembelian.index') }}'"
