...
<div x-data="returPenjualanBrowser()" x-init="init()" x-show="open" x-cloak x-transition.opacity
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-7xl flex flex-col overflow-hidden"
        ...
        <div
            class="px-6 py-4 border-b border-gray-200 flex items-center justify-between flex-shrink-0 bg-gradient-to-r from-rose-50 to-white">
            <div>
                <h3 class="text-xl font-bold text-gray-800">{{ 'Browse Retur Penjualan' }}</h3>
                <p class="text-sm text-gray-500 mt-0.5">{{ 'Pilih dokumen retur penjualan' }}</p>
            </div>
                ...
                <table id="{{ $tableId }}" class="min-w-full text-sm display nowrap stripe hover" style="width:100%">
                    <thead class="sticky top-0 z-10">
                        <tr class="bg-gradient-to-r from-gray-50 to-gray-100">
                            ...
                            <th class="text-left p-3 font-semibold text-gray-700 border-b-2 border-gray-200">{{ 'No. Retur' }}</th>
                            <th class="text-left p-3 font-semibold text-gray-700 border-b-2 border-gray-200">{{ 'No. Ref' }}</th>
                            ...
                            <th class="text-right p-3 font-semibold text-gray-700 border-b-2 border-gray-200">{{ 'Total' }}</th>
                            <th class="text-left p-3 font-semibold text-gray-700 border-b-2 border-gray-200">{{ 'Keterangan' }}</th>
