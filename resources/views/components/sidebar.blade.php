            ...
            <li x-data="{ open: false }" x-effect="if(!openSidebar) open = false">
                ...
                <ul x-show="open && openSidebar" x-transition
                    ...
                    @if ($hasSidebarPermission('printLaporanRekapPenjualan'))
                        ...
                        <li>
                            <a href="{{ route('reportingrekappenjualansalesproduk.index') }}"
                                class="flex items-center p-2 rounded hover:bg-gray-700">
                                <i class="fa-solid fa-chart-pie w-5 text-center flex-shrink-0 text-lg"></i>
                                <span class="ml-3">{{ 'Rekap Penjualan Sales By Produk' }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('reportingrekappenjualansalescustomer.index') }}"
                                class="flex items-center p-2 rounded hover:bg-gray-700">
                                <i class="fa-solid fa-chart-pie w-5 text-center flex-shrink-0 text-lg"></i>
