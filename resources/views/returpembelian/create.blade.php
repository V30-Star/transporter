                            ...
                            <div class="overflow-auto border border-gray-200 rounded-lg">
                                <table class="fpb-detail-table min-w-full text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        {{-- ROW EDIT UTAMA --}}
                                        <tr x-show="editingIndex !== null" class="border-t border-gray-150 align-top hover:bg-gray-50 bg-amber-50" x-cloak>
                                            ...
                                            <td class="p-2" style="width: 20rem; min-width: 20rem;">
                                                <div class="desc-inline-field flex w-full min-w-0 flex-nowrap items-stretch">
                                                    <div class="desc-inline-field__text min-w-0 flex-1 rounded-l-lg border border-gray-300 bg-gray-100 px-2 py-1 text-sm leading-5 text-gray-600 whitespace-normal break-words"
                                                        style="flex:1 1 auto !important; min-width:0 !important;"
                                            ...
                                            {{-- No Referensi --}}
                                            <td class="p-2">
                                                <input type="text" class="w-full border border-gray-250 rounded-lg px-2 py-1 bg-gray-100 text-gray-500 text-sm cursor-not-allowed"
                                            ...
                                            <td class="p-2 text-center">
                                                <div class="flex items-center justify-center gap-1.5 flex-wrap">
                                                    ...
                                                    <button type="button" @click="cancelEdit()"
                                                        class="px-2.5 py-1 rounded-lg text-xs bg-white border border-gray-300 text-gray-600 hover:bg-gray-50 transition-colors">Batal</button>
                                                </div>
                                            </td>
                                        </tr>
