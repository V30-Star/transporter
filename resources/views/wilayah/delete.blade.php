...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1800px] w-full mx-auto">
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated:
                {{ $wilayah->fupdatedat ? \Carbon\Carbon::parse($wilayah->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($wilayah->fcreatedat)->format('d M Y, H:i') }}
            </p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-gray-700 mb-4">
                        Apakah Anda yakin ingin menghapus wilayah <strong
                            class="text-gray-900">{{ $wilayah->fwilayahcode }} - {{ $wilayah->fwilayahname }}</strong>?
                    </p>
