...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[700px] mx-auto">
        <div class="text-center mb-6">
            ...
            <h2 class="text-xl font-bold text-gray-800">Konfirmasi Hapus Wilayah</h2>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-2">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium
                        ...
                        {{ $wilayah->fnonactive == '1' ? 'Non Active' : 'Active' }}
                    </span>
                </div>
            </div>
        ...
        @php
            $hasRelatedData = \Illuminate\Support\Facades\DB::table('mscustomer')
                ->where('fwilayah', $wilayah->fwilayahid)
                ->exists();
        @endphp
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <ul class="mt-2 text-sm text-red-600 list-disc list-inside space-y-1">
                        <li>Wilayah sudah digunakan dalam data Customer</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated: {{ $wilayah->fupdatedat ? \Carbon\Carbon::parse($wilayah->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($wilayah->fcreatedat)->format('d M Y, H:i') }}</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div class="p-6">
                <p class="text-gray-700 mb-4">
                    Apakah Anda yakin ingin menghapus wilayah <strong class="text-gray-900">{{ $wilayah->fwilayahcode }} - {{ $wilayah->fwilayahname }}</strong>?
                </p>
    ...
    <script>
        ...
        function confirmDelete() {
            ...
            fetch('{{ route('wilayah.destroy', $wilayah->fwilayahid) }}', {
                method: 'POST',
                headers: {
