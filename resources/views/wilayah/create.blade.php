...
@section('title', 'New - Master Wilayah')
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="fwilayahcode" value="{{ old('fwilayahcode') }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm uppercase focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 @error('fwilayahcode') border-red-400 @enderror"
                                placeholder="Masukkan Kode Wilayah" autofocus>
                            @error('fwilayahcode')
