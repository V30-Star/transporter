...
@section('content')
    ...
    <div x-data="groupproductData()" class="bg-white rounded shadow p-4">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        @if ($showActionsColumn)
                            <td class="border px-2 py-1 space-x-2 text-center">
                                ...
                                @if ($canDelete)
                                    <button
                                        @click="openDelete('{{ route('groupproduct.delete', $item->fgroupid) }}', $event)"
