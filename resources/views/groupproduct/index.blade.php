                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        @if ($showActionsColumn)
                            <td class="border px-2 py-1 space-x-2">
                                ...
                                @endif
                                @if ($canDelete)
                                    <a href="{{ route('groupproduct.delete', $item->fgroupid) }}">
                                        <button
                    ...
                    fetch(this.deleteUrl, {
                        ...
                        .then(result => {
                            ...
                            if (result.ok) {
                                ...
                                const table = $('#groupproductTable').DataTable();
                                if (rowToDelete) {
        ...
        $(function() {
            ...
            $('#groupproductTable').DataTable({
                ...
                initComplete: function() {
                    ...
                    // Handler Input (Delegasi) agar stabil
                    $container.on('input', '.dt-search .dt-input', function() {
                        ...
                        // Jalankan pencarian dengan nilai uppercase
