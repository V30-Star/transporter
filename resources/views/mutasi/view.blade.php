...
@section('content')
    @php
        ...
        $canPrint = in_array('updatePenerimaanBarang', $permissions, true) || in_array('deletePenerimaanBarang', $permissions, true) || in_array('createPenerimaanBarang', $permissions, true);
    @endphp
    <style>
        input:focus,
        select:focus,
                    ...
                    <div x-show="$store.mutasiDesc.show" x-cloak
                        ...
                        <div class="relative bg-white w-[92vw] max-w-lg rounded-2xl shadow-2xl overflow-hidden"
                            ...
                            <div class="px-5 py-4 space-y-2">
                                ...
                                <textarea x-model="$store.mutasiDesc.value" rows="5"
...
<script>
    ...
    function itemsTable() {
        return {
            ...
            openDesc(targetRow, readonly = true) {
