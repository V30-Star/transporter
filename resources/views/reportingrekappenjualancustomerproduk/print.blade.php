    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Rekap Penjualan Customer Per Produk</div>
                </div>
            </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: stretch; gap: 15px;">
                    ...
                    <div style="flex: 1; padding-right: 15px; border-right: 1px solid #000;">
                        <table class="info-col-table">
                            ...
                            <tr>
                                <td class="info-col-label">Group/Merek</td>
                                <td>:</td>
        ...
        @foreach ($rows->groupBy('fcustno') as $custNo => $customerRows)
            ...
            <div class="journal-block">
                ...
                <div class="subtotal-row subtotal-customer-row">
                    <div></div>
