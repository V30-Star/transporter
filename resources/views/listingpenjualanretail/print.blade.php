...
<head>
    ...
    <title>Listing Penjualan Retail</title>
    <!-- Fonts -->
...
<body>
    ...
    <div class="no-print">
        ...
        {{-- Excel Download --}}
        <a href="{{ route('listingpenjualanretail.excel', request()->all()) }}"
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Penjualan Retail</div>
                </div>
            </div>
        ...
        @foreach ($groupedData as $fsono => $details)
            @php
                ...
                $sign = $isReturn ? -1 : 1;
                $viewUrl = $isReturn ? route('returpenjualan.view', $h->ftranmtid) : route('penjualanretail.view', $h->ftranmtid);
                $editUrl = $isReturn ? route('returpenjualan.edit', $h->ftranmtid) : route('penjualanretail.edit', $h->ftranmtid);
