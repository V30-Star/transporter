                                    ...
                                    <tbody>
                                        <template x-for="(it, i) in savedItems" :key="it.uid || `item-${i}`">
                                            <tr class="border-t align-top hover:bg-gray-55">
                                                ...
                                                <td class="p-2">
                                                    <div class="px-2 py-1 text-sm text-gray-655 bg-gray-50 border rounded" x-text="it.frefpr || it.fnouref || (['INV','SRJ','SO','UM','RUJ'].includes(it.frefcode) ? it.frefcode : '') || '-'"></div>
                                                </td>
                                        ...
                                        <tbody>
                                            <template x-for="(it, i) in savedItems" :key="it.uid || `item-${i}`">
                                                <tr class="border-t align-top hover:bg-gray-50">
                                                    ...
                                                    <td class="p-2">
                                                        <template x-if="action === 'view'">
                                                            <div class="px-2 py-1 text-sm text-gray-650 bg-gray-50 border rounded" x-text="it.frefsrj || it.frefpr || it.fnouref || (['INV','SRJ','SO','UM','RUJ'].includes(it.frefcode) ? it.frefcode : '') || '-'"></div>
                                                        </template>
                                                        <template x-if="action !== 'view'">
                                                            <div>
    ...
    function customerBrowser() {
        return {
            ...
            chooseCustomer(customer) {
                ...
                if (!opt) {
                    opt = new Option(`${customer.fcustomercode} - ${customer.fcustomername}`, customer.fcustomercode,
                        true, true);
                    sel.add(opt);
                } else {
                    opt.selected = true;
