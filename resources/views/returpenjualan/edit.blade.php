        ...
        <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
                <nav class="flex text-xs font-semibold uppercase tracking-wider text-gray-400">
                    <a href="{{ route('returpenjualan.index') }}" class="hover:text-gray-600">Retur Penjualan</a>
                ...
                <h1 class="mt-1 text-2xl font-bold tracking-tight text-gray-900">
                    @if ($action === 'delete') Hapus Retur Penjualan
                    @elseif ($action === 'view') Lihat Retur Penjualan
                    @else Edit Retur Penjualan
                    @endif
                </h1>
            </div>
                                            ...
                                            <div class="flex items-center justify-between gap-6">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <select id="fapplyppn_input" name="fapplyppn"
                                                        ...
                                                        :disabled="!(includePPN || fapplyppn) || action === 'view' ||
                                                            action === 'delete'"
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <input type="number" min="0" max="100" id="fppnpersen"
                                                        name="fppnpersen" step="0.01" x-model.number="ppnRate"
                                                        :disabled="!(includePPN || fapplyppn) || action === 'view' ||
                                                            action === 'delete'"
