...
@section('title', 'Laporan Assembling')

@section('content')
    <div class="p-6 bg-white shadow-md rounded-lg">
        <h2 class="text-xl font-bold mb-4">Laporan Assembling</h2>
        ...
        <div id="filterModal" class="fixed inset-0 z-50 bg-black bg-opacity-50 hidden flex items-center justify-center">
            <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full p-6" onclick="event.stopPropagation()">
                <div class="flex justify-between items-center border-b pb-3 mb-4">
                    <h3 class="text-lg font-semibold">Laporan Assembling</h3>
                    <button onclick="toggleModal(false)"
                        class="text-gray-500 hover:text-gray-800 text-xl font-bold">&times;</button>
                </div>

                <form method="GET" action="{{ route('reportingassembling.printAssembling') }}">
                    ...
                    <div class="flex justify-end space-x-2 mt-6">
                        ...
                        <button type="submit" formaction="{{ route('reportingassembling.printAssembling') }}" formtarget="_blank"
