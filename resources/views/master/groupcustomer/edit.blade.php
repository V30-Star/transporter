    ...
    @if ($action === 'delete')
        ...
        <div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg max-w-sm w-full p-6">
                <h3 class="text-lg font-semibold mb-4">Konfirmasi hapus group customer ini?</h3>
                <form id="deleteForm" action="{{ route('groupcustomer.destroy', $groupcustomer->fgroupid) }}"
                    method="POST">
                    @csrf
                    @method('DELETE')
