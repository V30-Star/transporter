...
@section('title', $action === 'delete' ? 'Hapus Customer' : 'Edit Customer')
    ...
    <div x-data="{ showModal: false, open: true, selected: 'alamatsurat', frekening: '' }">
        <div class="bg-white rounded shadow p-6 md:p-8 max-w-5xl mx-auto">
            ...
            <h2 class="text-2xl font-bold mb-6 text-center">
                {{ $action === 'delete' ? 'Data Customer' : 'Edit Customer' }}
            </h2>
            ...
            $el.submit();
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div x-data="{ autoCode: true }" class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <label class="block text-sm font-medium">Kode Customer</label>
                                <input type="text" name="fcustomercode"
                        ...
                        <div>
                            <label class="block text-sm font-medium">NPWP</label>
                            <input type="text"
                                class="w-full border rounded px-3 py-2 @error('fnpwp') is-invalid @enderror"
                        ...
                        <div>
                            <label class="block text-sm font-medium">No. NIK</label>
                            <input type="text"
                                class="w-full border rounded px-3 py-2 @error('fnik') is-invalid @enderror"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('fkodefp', '010') }}" maxlength="3">
                                @error('fkodefp')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
        ...
        @if ($action === 'delete')
            ...
            <div id="deleteModal"
                ...
                <div class="bg-white rounded-lg shadow-lg max-w-sm w-full p-6">
                    ...
                    <p class="mb-2 font-medium">Hapus customer ini?</p>
                    <p class="mb-1 text-sm text-gray-600">Kode: <strong>{{ $customer->fcustomercode }}</strong></p>
                    <p class="mb-6 text-sm text-gray-600">Nama: <strong>{{ $customer->fcustomername }}</strong></p>
