                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-show="selected === 'alamatsurat'">
                            <textarea class="w-full border rounded px-3 py-2 @error('faddress') is-invalid @enderror" name="faddress" id="faddress"
                                placeholder="Masukkan Alamat Surat" cols="10" rows="6">{{ old('faddress', $customer->faddress) }}</textarea>
                            @error('faddress')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email"
                            ...
                            id="femail" placeholder="Masukkan Email" value="{{ old('femail', $customer->femail) }}">
                        @error('femail')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        ...
                        <input type="number"
                            ...
                            id="ftempo" value="{{ old('ftempo', $customer->ftempo) }}" maxlength="3">
                        @error('ftempo')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                            ...
                            id="flimit" placeholder="Masukkan Limit Piutang"
