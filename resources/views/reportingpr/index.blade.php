...
@section('title', 'Laporan Permintaan Pembelian')

@section('content')
    <div class="p-6 bg-white shadow-md rounded-lg">
        <h2 class="text-xl font-bold mb-4">Laporan Permintaan Pembelian</h2>
            ...
            <div class="bg-white rounded-lg shadow-2xl max-w-xl w-full p-6" onclick="event.stopPropagation()">
                ...
                <form method="GET" action="{{ route('reportingpr.printPrh') }}">
                    ...
                    <div class="flex justify-end space-x-2 mt-6">
                        ...
                        <button type="submit" formaction="{{ route('reportingpr.printPrh') }}" formtarget="_blank"
