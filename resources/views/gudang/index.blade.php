    ...
    <div x-data="{
            ...
            <tbody>
                @forelse($gudangs as $item)
                    <tr class="hover:bg-gray-50">
                        <!-- Display fcabangname using the relationship -->
                        ...
                        @if ($showActionsColumn)
                            <td class="border px-2 py-1 space-x-2">
                                ...
                                @if ($canDelete)
                                    <button @click="openDelete('{{ route('gudang.destroy', $item->fgudangid) }}')"
        ...
        <div class="mt-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-sm">Page {{ $gudangs->currentPage() }} of {{ $gudangs->lastPage() }}</span>
