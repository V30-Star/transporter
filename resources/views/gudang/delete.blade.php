...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1800px] w-full mx-auto">
        <div class="text-center mb-6">
            ...
            <h2 class="text-xl font-bold text-gray-800">Konfirmasi Hapus Gudang</h2>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-2">
                    <span
                        ...
                        {{ $gudang->fnonactive == '1' ? 'Non Active' : 'Active' }}
                    </span>
                </div>
            </div>

            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-700">Stok Penjualan</div>
                <div class="col-span-2">
                    <span
                        class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium
                        {{ $gudang->fstokpenjualan == '1' ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700' }}">
                        {{ $gudang->fstokpenjualan == '1' ? 'Non Active' : 'Active' }}
                    </span>
                </div>
            </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated:
                {{ $gudang->fupdatedat ? \Carbon\Carbon::parse($gudang->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($gudang->fcreatedat)->format('d M Y, H:i') }}
            </p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-gray-700 mb-4">
                        Apakah Anda yakin ingin menghapus gudang <strong class="text-gray-900">{{ $gudang->fwhcode }} -
                            {{ $gudang->fwhname }}</strong>?
                    </p>
