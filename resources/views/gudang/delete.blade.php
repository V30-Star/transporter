...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[700px] mx-auto">
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <ul class="mt-2 text-sm text-red-600 list-disc list-inside space-y-1">
                        <li>Gudang sudah digunakan dalam Transaksi Stok</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated: {{ $gudang->fupdatedat ? \Carbon\Carbon::parse($gudang->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($gudang->fcreatedat)->format('d M Y, H:i') }}</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div class="p-6">
                <p class="text-gray-700 mb-4">
                    Apakah Anda yakin ingin menghapus gudang <strong class="text-gray-900">{{ $gudang->fwhcode }} - {{ $gudang->fwhname }}</strong>?
                </p>
