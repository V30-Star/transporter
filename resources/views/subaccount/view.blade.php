        ...
        <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-1">Kode Subaccount</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-1">Nama Subaccount</label>
