...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[700px] mx-auto">
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <ul class="mt-2 text-sm text-red-600 list-disc list-inside space-y-1">
                        <li>Subaccount sudah digunakan dalam transaksi jurnal</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated: {{ $subaccount->fupdatedat ? \Carbon\Carbon::parse($subaccount->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($subaccount->fcreatedat)->format('d M Y, H:i') }}</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div class="p-6">
                <p class="text-gray-700 mb-4">
                    Apakah Anda yakin ingin menghapus subaccount <strong class="text-gray-900">{{ $subaccount->fsubaccountcode }} - {{ $subaccount->fsubaccountname }}</strong>?
                </p>
