...
@section('title', 'Listing Faktur Pembelian')
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full p-6">
                <div class="flex justify-between items-center border-b pb-4 mb-4">
                    <h3 class="text-xl font-bold text-gray-800">Listing Faktur Pembelian</h3>
                    <button onclick="toggleModal(false)"
                        class="text-gray-400 hover:text-gray-600 text-2xl font-bold">&times;</button>
                </div>

                <form method="GET" action="{{ route('listingfakturpembelian.print') }}" target="_blank">
                    <div class="space-y-4">
                        {{-- Cabang checkboxes --}}
                        <div>
                        ...
                        <div>
                            <label class="block text-xs font-bold uppercase mb-1">Type Transaksi</label>
                            <select name="type_transaksi" class="w-full border rounded px-3 py-2 text-sm">
                        ...
                        <div>
                            ...
                            <select name="sort_by" class="w-full border rounded px-3 py-2 text-sm">
                                <option value="0">No. Faktur Pembelian</option>
                        ...
                        <div class="flex gap-4 bg-gray-50 p-3 rounded border">
                            <label class="flex items-center text-sm font-semibold">
                                <input type="checkbox" name="is_detail" checked class="mr-2"> Detail
                            </label>
                            <label class="flex items-center text-sm font-semibold">
                                <input type="checkbox" name="is_rekap" class="mr-2"> Rekap
                            </label>
                        </div>
                    </div>
