...
<head>
    ...
    <style>
        * {
        ...
        .po-header {
            display: grid;
            grid-template-columns: 24mm 18mm 1fr 18mm 16mm 16mm 22mm 16mm;
            gap: 1px;
            font-size: 8.5px;
            padding: 2px 6px;
            align-items: center;
...
<body>
    @php
        ...
        $suppText = $filters['customer_from'] !== '' || $filters['customer_to'] !== ''
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Bayar Supplier</div>
                </div>
            </div>
        ...
        @foreach ($groupedRecords as $voucherNo => $voucherRecords)
            @php
                ...
                $viewUrl = route('bayarsupplier.view', $voucherNo);
                $editUrl = route('bayarsupplier.edit', $voucherNo);
            @endphp
