...
@section('content')
            ...
            <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full p-6" onclick="event.stopPropagation()">
                ...
                <form method="GET" action="{{ route('reportingpelunasansupplier.print') }}" target="_blank">
                    <div class="space-y-4">
                        ...
                        <div id="alpineBrowseWrapper" x-data="pelunasanSupplierReport()">
                            <div>
    ...
    <script>
        ...
        function pelunasanSupplierReport() {
            return {
                accountCode: '',
                accountLabel: '',
                allSalesman: true,
                ...
                openSupplierBrowse(field) {
                    this.activeSupplierField = field;
