                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="salesman_code" class="select2 w-full">
                            ...
                            @foreach($salesmen as $s)
                                <option value="{{ $s->fsalesmancode }}">{{ $s->fsalesmancode }} - {{ $s->fsalesmanname }}</option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
                            <div class="flex gap-2 mb-2">
                                ...
                                <button type="button" onclick="addProduct()"
                                    class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-bold">+ Add</button>
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-2 bg-gray-50 p-3 rounded border">
                        <label class="flex items-center text-sm font-semibold cursor-pointer">
                            <input type="checkbox" name="detail" value="1" checked class="mr-2 w-4 h-4 text-blue-600 focus:ring-blue-500"> Detail
                        </label>
                        <label class="flex items-center text-sm font-semibold cursor-pointer">
                            <input type="checkbox" name="rekap" value="1" class="mr-2 w-4 h-4 text-blue-600 focus:ring-blue-500"> Rekap
                        </label>
                    </div>
                </div>
