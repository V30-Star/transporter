...
<head>
    ...
    <title>Listing Retur Penjualan</title>
    <!-- Fonts -->
    ...
    <style>
        * {
        ...
        .po-header {
            display: grid;
            grid-template-columns: 25mm 18mm 1fr 24mm 20mm 16mm 20mm 14mm;
            gap: 1px;
            font-size: 8.5px;
            padding: 2px 6px;
            align-items: center;
        ...
        .po-detail {
            display: grid;
            grid-template-columns: 25mm 1fr 25mm 18mm 20mm 24mm;
            gap: 1px;
            font-size: 8px;
            padding: 2px 6px;
            align-items: center;
...
<body>
    ...
    <div class="no-print">
        ...
        <a href="{{ route('listingreturpenjualan.excel', request()->query()) }}"
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Retur Penjualan</div>
                </div>
            </div>
        ...
        @foreach ($grouped as $items)
            @php
                ...
                $viewUrl = route('returpenjualan.view', $h->fstockmtid);
                $editUrl = route('returpenjualan.edit', $h->fstockmtid);
            @endphp
