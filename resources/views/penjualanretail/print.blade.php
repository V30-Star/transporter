    ...
    <style>
        ...
        * {
        ...
        .sheet {
            ...
            overflow: hidden;
            margin: 0.2in auto;
            /* Kanan 1.85in: area aman kertas ~3.78in (5.83 - 0.2 - 1.85). Sesuaikan kalau kertas beda */
            padding: 0.3in 1.85in 0.2in 0.2in;
            background: #fff;
        ...
        @media print {
            ...
            * {
            ...
            .sheet {
                ...
                padding: 0.3in 1.85in 0.2in 0.2in !important;
