    ...
    <style>
        ...
        * {
        ...
        .sheet {
            ...
            overflow: hidden;
            margin: 0.2in auto;
            /* Kanan 1.75in: area aman kertas ~3.88in (5.83 - 0.2 - 1.75). Sesuaikan kalau kertas beda */
            padding: 0.3in 1.75in 0.2in 0.2in;
            background: #fff;
        ...
        @media print {
            ...
            * {
            ...
            .sheet {
                ...
                padding: 0.3in 1.75in 0.2in 0.2in !important;
