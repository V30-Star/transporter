...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Ukuran kertas: 5.5in x 5.5in. Kalau form fisik beda, ganti di sini + .sheet (layar & print) */
        @page {
            size: 5.5in 5.5in;
            margin: 0;
        }
        ...
        .sheet {
            ...
            overflow: hidden;
            margin: 0.2in auto;
            /* Kanan 1.90in: area aman kertas ~3.40in (5.5 - 0.2 - 1.90). Sesuaikan kalau kertas beda */
