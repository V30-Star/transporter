...
@section('title', 'Penjualan Retail')
...
@section('content')
    <div x-data class="bg-white rounded shadow p-4">
        ...
        @php
            ...
            $canCreate = in_array('createPenjualanRetail', $permissions, true);
            $canEdit = in_array('updatePenjualanRetail', $permissions, true);
            $canDelete = in_array('deletePenjualanRetail', $permissions, true);
        ...
        <div class="flex justify-end items-center mb-4">
            <div></div>
            @if ($canCreate)
                <a href="{{ route('penjualanretail.create') }}"
    ...
    <script>
        ...
        $(function() {
            ...
            if (hasActions) {
                columns.push({
                    ...
                    render: function(data, type, row) {
                        ...
                        if (canView) {
                            html += `<a href="penjualanretail/${data}/view">
                        ...
                        if (canEdit) {
                            ...
                            Edit
                                ...
                                html += `<a href="penjualanretail/${data}/edit" class="inline-flex items-center bg-yellow-500 text-white px-3 py-1.5 text-xs rounded hover:bg-yellow-600">
                            <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                            </svg>
                            Edit
                        ...
                        if (canDelete) {
                            let deleteUrl = '{{ route('penjualanretail.index') }}/' + data + '/delete';
            ...
            $('#invoiceorderTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('penjualanretail.index') }}',
                    type: 'GET',
                    data: function(d) {
                ...
                initComplete: function() {
                    ...
                    $(document).on('click.invoice-column-search', function(e) {
