...
<head>
    ...
    <title>Listing Adjustment Stock</title>
    <style>
        ...
        * {
        ...
        .po-header {
            display: grid;
            grid-template-columns: 25mm 17mm 15mm 22mm 1fr 20mm 30mm 15mm;
            gap: 1px;
            font-size: 8px;
            padding: 2px 8px;
            align-items: center;
        ...
        .po-detail {
            display: grid;
            grid-template-columns: 25mm 1fr 25mm 25mm 30mm;
            gap: 1px;
            font-size: 8px;
            padding: 2px 8px;
            align-items: center;
    ...
    <div class="report-wrapper" id="reportWrapper">
        @if ($fakturpembelianData->isEmpty())
            <div class="page-a4 page-a4-strict">
                <div class="header-section">
                    <div class="warehouse-info-kiri" style="top: 15px;">
                        Gudang: {{ $activeWarehouseName ?? 'Semua' }}
                        <br>Cabang: {{ request()->has('branch_codes') ? implode(', ', (array) request()->input('branch_codes')) : 'Semua' }}
                    </div>
                    <h2>Listing Adjustment Stock</h2>
