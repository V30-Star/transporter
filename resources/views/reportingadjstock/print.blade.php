...
<head>
    ...
    <style>
        * {
        ...
        .po-header {
            display: grid;
            grid-template-columns: 28mm 18mm 14mm 22mm 1fr 24mm 24mm 13mm;
            gap: 1px;
            font-size: 8.5px;
            padding: 2px 6px;
            align-items: center;
        ...
        .po-detail {
            display: grid;
            grid-template-columns: 25mm 1fr 20mm 22mm 24mm;
            gap: 1px;
            font-size: 8px;
            padding: 2px 6px;
            align-items: center;
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Adjustment Stok</div>
                </div>
            </div>
                    ...
                    <div style="flex: 1; padding-right: 15px; border-right: 1px solid #000;">
                        <table class="info-col-table">
                            <tr>
                                ...
                                <td>{{ $activeWarehouseName ?? 'Semua' }}</td>
                            </tr>
                            <tr>
        ...
        @foreach ($fakturpembelianData as $fakturpembelian)
            @php
                $viewUrl = route('adjstock.view', $fakturpembelian->fstockmtid);
                $editUrl = route('adjstock.edit', $fakturpembelian->fstockmtid);
            @endphp
        ...
        <div class="po-totals-panel-wrapper">
            ...
            <div class="po-totals-container">
                <div class="po-total-row grand-total-row">
                    <span>TOTAL NILAI ADJUSTMENT</span>
