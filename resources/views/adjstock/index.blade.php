            ...
            const columns = [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        // Delete Button
                        // if (canDelete) {
                        html += `<button onclick="event.stopPropagation(); Alpine.store('adjstockStore').openDelete('adjstock/${data}', event)" 
                        ...
                        html += `<a href="adjstock/${row.fstockmtno}/print" target="_blank" class="inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
