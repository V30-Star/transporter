...
<script>
    ...
    window.accountBrowser = function() {
        return {
            ...
            choose(w) {
                // Langsung update elemen saat pilih
                const sel = document.getElementById('accountSelect');
                const hid = document.getElementById('accountIdHidden');

                if (sel && hid) {
                    // Update select untuk tampilan
                    sel.value = w.faccid || '';

                    // Update hidden input (ini yang dikirim ke server)
                    hid.value = w.faccid || '';
                ...
                // Tetap dispatch event untuk komponen lain yang mungkin butuh
            ...
            init() {
                ...
                // Setup event listener untuk account-picked juga
