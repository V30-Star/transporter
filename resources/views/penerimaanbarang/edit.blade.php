    ...
    <div x-data="{ open: true }">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                            ...
                            <div class="lg:col-span-12">
                                ...
                                <textarea readonly name="fket" rows="3" class="w-full border rounded px-3 py-2 text-gray-700 @error('fket') border-red-500 @enderror"
                        ...
                        {{-- ============================================ --}}
                    @else
                        <form action="{{ route('penerimaanbarang.update', $penerimaanbarang->fstockmtid) }}"
                            method="POST" class="mt-6" x-data="{ showNoItems: false }"
                            @submit.prevent="
      ...
      ">
                            ...
                            <div class="mt-8 flex justify-center gap-4">
                                ...
                                <button type="button"
                                    @click="window.location.href='{{ route('penerimaanbarang.index') }}'"
                                    class="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-600 flex items-center">
