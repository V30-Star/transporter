                ...
                <div class="a4-container">
                    ...
                    @foreach ($pageData as $index => $fakturpembelian)
                        ...
                        <div class="po-header">
                            ...
                            <div class="text-right">{{ number_format($fakturpembelian->famountremain ?? 0, 2, ',', '.') }}</div>
                            <div class="text-right">{{ number_format($fakturpembelian->famountpajak ?? 0, 2, ',', '.') }}</div>
                            <div class="text-right">{{ number_format($fakturpembelian->famountmt ?? 0, 2, ',', '.') }}</div>
                        </div>
