    ...
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1800px] w-full mx-auto">
        ...
        <div class="bg-gray-50 rounded-lg p-6 space-y-4">
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Account #</div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Nama Account</div>
                <div class="col-span-2 text-sm font-semibold text-gray-900 uppercase">
                    {{ $account->faccname }}
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Type Account</div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Saldo Normal</div>
                <div class="col-span-2 text-sm font-semibold text-gray-900">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Initial Jurnal</div>
                <div class="col-span-2 text-sm font-semibold text-gray-900">
                    {{ $account->finitjurnal }}
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Sub Account</div>
                <div class="col-span-2 text-sm font-semibold text-gray-900">
                    Yes - 
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Status</div>
            ...
            @if ($accountHeader)
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">Account Header</div>
                <div class="col-span-2 text-sm font-semibold text-gray-900 uppercase">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-bold text-gray-900">User Level</div>
                <div class="col-span-2 text-sm font-semibold text-gray-900">
