    ...
    <div class="max-w-4xl mx-auto py-8 px-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-bold text-gray-800 mb-1">Kode Account</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-800 mb-1">Nama Account</label>
        ...
        <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
            ...
            <div class="p-4 space-y-4">
                ...
                {{-- Initial Jurnal --}}
                <div>
                    <label class="block text-xs font-bold text-gray-800 mb-1">Initial Jurnal</label>
