...
<div>
    ...
    <div class="max-w-4xl mx-auto py-8 px-6">
        ...
        <form action="{{ route('groupcustomer.update', $groupcustomer->fgroupid) }}" method="POST" id="formGroupcustomer">
            @csrf
            @method('PATCH')
            ...
            <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
                <div class="px-4 pt-3 pb-0">
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400">Identitas Group Customer</p>
                </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="fgroupname" id="fgroupname"
                                value="{{ old('fgroupname', $groupcustomer->fgroupname) }}"
                                ...
                                maxlength="50" placeholder="cth. Group Retail" autofocus>
                            @error('fgroupname')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
                ...
                <div class="p-4 space-y-4">
                    ...
                    {{-- Status Aktif --}}
                    <div x-data="{ active: {{ old('fnonactive', $groupcustomer->fnonactive) == '1' ? 'false' : 'true' }} }">
                        <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-gray-50 cursor-pointer hover:border-gray-300 transition-colors"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400 mt-0.5">Non-aktif menyembuyen group customer dari transaksi baru</p>
                            </div>
