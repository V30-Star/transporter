...
@section('title', 'New - Master Supplier')
...
@section('content')
    ...
    <div x-data="{ open: true, selected: 'surat', nonactive: {{ old('fnonactive') == '1' ? 'true' : 'false' }} }">
            ...
            <form action="{{ route('supplier.store') }}" method="POST" data-form-draft="true"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="fsuppliercode" value="{{ old('fsuppliercode') }}"
                                class="field-input uppercase @error('fsuppliercode') is-invalid border-red-500 @enderror"
                                autofocus>
                            @error('fsuppliercode')
                        ...
                        <div>
                            <label class="field-label">Nama Alias</label>
                            <input type="text" name="fsupplieralias" value="{{ old('fsupplieralias') }}"
                                class="field-input uppercase @error('fsupplieralias') border-red-500 @enderror">
                            @error('fsupplieralias')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="section-card mb-0">
                        ...
                        <textarea name="faddress" rows="6"
                            class="field-textarea resize-y @error('faddress') border-red-500 @enderror">{{ old('faddress') }}</textarea>
                        @error('faddress')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="section-card">
                    ...
                    <textarea name="fmemo" rows="4"
                        class="field-textarea @error('fmemo') border-red-500 @enderror">{{ old('fmemo') }}</textarea>
                    @error('fmemo')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
