...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1800px] w-full mx-auto">
        ...
        @php
            ...
            $hasRelatedData =
                \Illuminate\Support\Facades\DB::table('tr_poh')->where('fsupplier', $supplierCode)->exists() ||
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated:
                {{ $supplier->fupdatedat ? \Carbon\Carbon::parse($supplier->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($supplier->fcreatedat)->format('d M Y, H:i') }}
            </p>
        </div>
    </div>
