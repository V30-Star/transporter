...
@section('content')
    ...
    <div x-data="currencyData()" class="bg-white rounded shadow p-4">
            ...
            <tbody>
                @foreach ($currencys as $item)
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="border px-2 py-1">{{ $item->fcurrcode }}</td>
                        <td class="border px-2 py-1">{{ $item->fcurrname }}</td>
