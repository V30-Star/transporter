...
@section('content')
    <div x-data="{
        ...
        @php
            ...
            $canCreate = in_array('createAssembling', $permissions, true);
            $canEdit = in_array('updateAssembling', $permissions, true);
            $canDelete = in_array('deleteAssembling', $permissions, true);
        ...
        <div class="flex justify-end items-center mb-4">
            ...
            @if ($canCreate)
                <a href="{{ route('assembling.create') }}"
                    @click="if (@js($createLimitReached)) { $event.preventDefault(); openCreateLimitModal(); }"
