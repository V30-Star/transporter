                ...
                <div class="overflow-auto border rounded">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                            ...
                            <!-- ROW EDIT UTAMA -->
                            <tr x-show="editingIndex !== null && editingTab === activeTab" class="border-t align-top"
                                x-cloak>
                                ...
                                <td class="p-2 text-right">
                                    <input type="number" class="border rounded px-2 py-1 w-24 text-right" min="0"
                            ...
                            <!-- ROW EDIT DESC -->
                            <tr x-show="editingIndex !== null && editingTab === activeTab" class="bg-amber-50 border-b"
                                x-cloak>
                                <td class="p-0"></td>
                                <td class="p-0"></td>
                                <td class="p-0"></td>
                            ...
                            <!-- ROW DRAFT UTAMA -->
                            <tr class="border-t align-top">
                                <td class="p-2" x-text="getItemsByTab(activeTab).length + 1"></td>
                            ...
                            <!-- ROW DRAFT DESC -->
                            <tr :class="activeTab === 'bahan_baku' ? 'bg-green-50' : 'bg-blue-50'" class="border-b">
                                <td class="p-0"></td>
                                <td class="p-0"></td>
                                <td class="p-0"></td>
                                <td class="p-0"></td>
