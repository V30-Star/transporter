    ...
    <div class="p-4 grid grid-cols-3 gap-3">
        ...
        <div class="lg:col-span-12">
            ...
            @enderror
                ...
                <div class="hidden">
                    <template x-for="(item, index) in savedItems" :key="item.uid">
                        <div>
                ...
                <script>
                    ...
                    function itemsTable() {
                        return {
                            ...
                            // === ORIGINAL PROPERTIES ===
                            showNoItems: false,
                            savedItems: @json($initialAssemblingItems),
                            draft: newRow(),
                            editingIndex: null,
                            editRow: newRow(),
                            totalHarga: 0,
