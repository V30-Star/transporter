...
<body>
    ...
    <div class="no-print">
        <button
            style="padding:6px 14px;background:#3b82f6;color:white;border:none;border-radius:4px;cursor:pointer;font-size:13px;font-weight:bold;"
            ...
            <div class="a4-container">
                <div class="header-section">
                    <div class="header-center">
                        <h2>SO Belum Dikirim By Produk</h2>
        ...
        @else
            ...
            @foreach ($chunkedData as $pageIndex => $pageData)
                <div class="a4-container">
                    ...
                    {{-- Data --}}
                    @foreach ($pageData as $prdCode => $rows)
                        @php $prdQty = 0; @endphp
                        ...
                        <div class="prd-subtotal">
                            ...
                            <div class="text-right text-red">{{ number_format($prdQty, 2, ',', '.') }}</div>
                            <div></div>
                        </div>

                        @php $grandTotalQty += $prdQty; @endphp
                    @endforeach
