...
<div>
    ...
    <div class="max-w-4xl mx-auto py-8 px-6">
        ...
        <form action="{{ route('satuan.update', $satuan->fsatuanid) }}" method="POST" id="formSatuan">
            @csrf
            @method('PATCH')
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="fsatuanname" id="fsatuanname"
                                value="{{ old('fsatuanname', $satuan->fsatuanname) }}"
                                ...
                                maxlength="50" placeholder="cth. PCS / PIECE" autofocus>
                            @error('fsatuanname')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
                ...
                <div class="p-4 space-y-4">
                    ...
                    {{-- Status Aktif --}}
                    <div x-data="{ active: {{ old('fnonactive', $satuan->fnonactive) == '1' ? 'false' : 'true' }} }">
