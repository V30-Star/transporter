...
@section('content')
    <div class="bg-white rounded shadow p-6 md:p-8 max-w-[1800px] w-full mx-auto">
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Last updated:
                {{ $satuan->fupdatedat ? \Carbon\Carbon::parse($satuan->fupdatedat)->format('d M Y, H:i') : \Carbon\Carbon::parse($satuan->fcreatedat)->format('d M Y, H:i') }}
            </p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-gray-700 mb-4">
                        Apakah Anda yakin ingin menghapus satuan <strong class="text-gray-900">{{ $satuan->fsatuancode }} -
                            {{ $satuan->fsatuanname }}</strong>?
                    </p>
