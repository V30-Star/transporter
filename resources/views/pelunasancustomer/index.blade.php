        ...
        <table id="pelunasanCustomerTable" class="min-w-full border text-sm">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border px-2 py-2">No.Faktur</th>
                    ...
                    <tr data-filter-year="{{ \Carbon\Carbon::parse($record->fkasmtdate)->format('Y') }}"
                        ...
                        <td class="border px-2 py-2 text-right whitespace-nowrap">
                            <div class="flex items-center justify-end gap-1.5 flex-nowrap">
                                <a href="{{ route('pelunasancustomer.view', $record->fkasmtno) }}"
                                ...
                                <a href="{{ route('pelunasancustomer.edit', $record->fkasmtno) }}"
                                ...
                                <a href="{{ route('pelunasancustomer.delete', $record->fkasmtno) }}"
...
@push('styles')
    ...
    <style>
        ...
        #pelunasanCustomerTable td {
            vertical-align: middle;
        }

        #pelunasanCustomerTable th:last-child,
        #pelunasanCustomerTable td:last-child {
            text-align: right;
            white-space: nowrap;
        }
    ...
    <script>
        $(function() {
            ...
            const dateFilter = function(settings, data, dataIndex) {
                if (settings.nTable.id !== 'pelunasanCustomerTable') {
                    return true;
                }
            ...
            const table = $('#pelunasanCustomerTable').DataTable({
                pageLength: 10,
                ...
                initComplete: function() {
                    const wrapper = document.querySelector('#pelunasanCustomerTable_wrapper .dt-search');
