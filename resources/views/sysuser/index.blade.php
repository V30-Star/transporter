...
@section('content')
    <div x-data="sysuserData()" class="bg-white rounded shadow p-4">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        @if ($showActionsColumn)
                            <td class="border px-2 py-1">
                                ...
                                @if ($canDelete)
                                    <button @click="openDelete('{{ route('sysuser.destroy', $sysuser->fuid) }}', $event)"
                    ...
                    fetch(this.deleteUrl, {
                        ...
                        .then(result => {
                            ...
                            if (result.ok) {
                                ...
                                const table = $('#sysuserTable').DataTable();
                                if (rowToDelete) {
