...
<body>
    ...
    @php
        ...
        foreach ($dt as $r) {
            ...
            $disc = is_numeric($r->fdiscpersen ?? null) ? (float) $r->fdiscpersen : 0;
                    ...
                    <div style="width: 50%; box-sizing: border-box; padding-left: 6px;">
                        <table class="info-table" style="margin-top: 0; width: 100%;">
                            ...
                            <tr>
                                <td>No.Ref</td>
                                <td>:</td>
                                <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ $hdr->frefno }}</td>
                            </tr>
                            @endif
                            <tr>
                                <td>Gudang</td>
            ...
            <tbody id="raw-rows">
                @foreach ($dt as $i => $r)
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="width: 30%; color: #000; font-weight: bold;" colspan="3">{{ number_format((float) ($r->ftotprice ?? $r->famount ?? ($r->fqty * $r->fprice)), 0, ',', '.') }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
