                ...
                <form action="{{ route('pemakaianbarang.store') }}" method="POST" class="mt-6" @submit="onSubmit($event)"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                        ...
                        <div class="lg:col-span-4" x-data="{ autoCode: true }">
                            <label class="block text-sm font-medium mb-1">No. Journal</label>
                            ...
                            <table class="min-w-full text-sm">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="p-2 text-left w-24">Referensi#</th>
                                        <th class="p-2 text-left w-24">D/K</th>
                                        <th class="p-2 text-left w-24">Uraian</th>
                                        <th class="p-2 text-right w-36">Jumlah</th>
                                ...
                                <tbody>
                                    <template x-for="(it, i) in savedItems" :key="it.uid">
                                        ...
                                        <tr class="border-t align-top">
                                            ...
                                            <td class="p-2 text-left" x-text="it.fdkt"></td>
                                            <td class="p-2 text-left" x-text="it.fdesc"></td>
                                    ...
                                    <tr x-show="editingIndex !== null" class="border-t align-top" x-cloak>
                                        ...
                                        <td class="p-2">
                                            <input type="text"
                                                class="w-full border rounded px-2 py-1 bg-gray-100 text-gray-600"
                                                :value="editRow.fdkt" disabled placeholder="D/K">
                                        </td>
                                        ...
                                        <td class="p-2">
                                            <input type="text"
                                                class="w-full border rounded px-2 py-1 bg-gray-100 text-gray-600"
                                                :value="editRow.fdesc" disabled placeholder="Uraian">
                                        </td>
