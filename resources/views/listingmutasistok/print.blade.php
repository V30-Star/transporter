...
<head>
    ...
    <style>
        * {
        ...
        /* Alignment */
        .mt-header-labels > div:nth-child(1),
        .mt-header-labels > div:nth-child(3),
    ...
    <div id="raw-source" style="display: none;">
        <div class="header-section">
            <div class="header-row">
                ...
                <div>
                    <div class="title-so">Listing Mutasi Stok</div>
                </div>
            </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: stretch; gap: 15px;">
                    ...
                    <div style="flex: 1; padding-right: 15px; border-right: 1px solid #000;">
                        <table class="info-col-table">
                            <tr>
                                <td class="info-col-label">Gudang Asal</td>
                                <td style="width: 8px;">:</td>
                                <td>{{ request('warehouse_from') ?: 'Semua' }}</td>
                            </tr>
                            <tr>
                                <td class="info-col-label">Gudang Tujuan</td>
                                <td>:</td>
                                <td>{{ request('warehouse_to') ?: 'Semua' }}</td>
                            </tr>
                            <tr>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const mtHeaderLabelsHtml = rawSource.querySelector(".mt-header-labels").outerHTML;
        const mtDetailLabelsEl = rawSource.querySelector(".mt-detail-labels");
        const mtDetailLabelsHtml = mtDetailLabelsEl ? mtDetailLabelsEl.outerHTML : "";
