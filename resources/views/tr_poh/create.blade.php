                            ...
                            <table class="min-w-full text-sm">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="p-2 text-left w-64">Nama Produk</th>
                                        ...
                                        <th class="p-2 text-right w-24 whitespace-nowrap">Terima</th>
                                ...
                                <tbody>
                                    {{-- ============================================================
                                         BARIS TERSIMPAN — inline editable, satu <tr> per item
                                         ============================================================ --}}
                                    <template x-for="(it, i) in savedItems" :key="it.uid">
                                        <tr class="border-t align-top transition-colors"
                                            ...
                                            <td class="p-2 text-right">
                                                <input type="number"
                                                    class="w-full border rounded px-2 py-1 bg-gray-100 text-gray-600 text-right text-sm"
                                                    min="0" step="1" :value="it.fterima ?? 0" disabled>
                                            </td>
                                            ...
                                            <td class="p-2 text-right">
                                                <input type="number"
                                                    ...
                                                    x-model.number="it.fdisc" :id="'disc_saved_' + i"
                                                    @focus="activeRow = it.uid; $event.target.select()"
                                                    @blur="activeRow = null" @input="recalc(it)"
                                            ...
                                            <td class="p-2 text-right text-sm" x-text="fmt(it.ftotal)"></td>
                                    ...
                                    <tr class="border-t bg-green-50 align-top">
                                        ...
                                        {{-- Total Harga (readonly) --}}
                                        <td class="p-2 text-right text-sm" x-text="fmt(draft.ftotal)"></td>
...
<script>
                ...
                this.dataTable = $('#supplierBrowseTable').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            width: '15%',
                            render: () =>
                                '<button type="button" class="btn-choose px-4 py-1.5 rounded-md text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white">Pilih</button>'
                        }
                    ],
                    pageLength: 10,
                    lengthMenu: [
    ...
    function itemsTable() {
        ...
        return {
            ...
            activeRow: null,
            // target browse: 'draft' | index angka
            browseTarget: 'draft',
            ...
            get netFromGross() {
                return (+this.totalHarga || 0) - this.ppnIncluded;
            },
            get ppnAdded() {
                const rate = +this.ppnRate || 0;
                if (!this.includePPN || this.fapplyppn) return 0;
                return Math.round((+this.totalHarga || 0) * (rate / 100));
            },
            get ppnAmount() {
                if (this.fapplyppn) return this.ppnIncluded;
                if (this.includePPN) return this.ppnAdded;
                return 0;
            },
            get grandTotal() {
                const total = +this.totalHarga || 0;
            ...
            recalcTotals() {
                this.totalHarga = this.savedItems.reduce((sum, it) => sum + it.ftotal, 0);
            },
            ...
            addIfComplete() {
                ...
                const dupe = this.savedItems.find(it =>
                    it.fitemcode === r.fitemcode && it.fsatuan === r.fsatuan && (it.frefpr || '') === (r.frefpr ||
                        '')
                );
                if (dupe) {
                ...
                this.table = $('#prTable').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            className: 'text-center',
                            render: () =>
                                '<button type="button" class="btn-pick px-4 py-1.5 rounded-md text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white">Pilih</button>'
                        }
                    ],
                    pageLength: 10,
                    lengthMenu: [
