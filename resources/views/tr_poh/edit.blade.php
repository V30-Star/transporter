                            ...
                            @if ($canPrint)
                                ...
                                @if ($isPrinted)
                                    <button type="button"
                                        ...
                                        class="inline-flex items-center gap-2 px-5 py-2 border border-gray-300 bg-white text-gray-600 hover:bg-gray-50 hover:border-gray-400 text-sm font-medium rounded-lg transition-colors">
