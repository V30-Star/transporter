                    ...
                    <div class="p-4 space-y-4">
                        @if ($canApproval)
                            <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-gray-50 cursor-pointer hover:border-gray-300 transition-colors"
                                x-data="{ active: {{ old('fapproval', $tr_poh->fapproval ?? 0) ? 'true' : 'false' }} }"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            @if ($canClosePo)
                                <button type="button" onclick="showClosePoModal()"
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-amber-500 text-white text-sm font-medium rounded-lg hover:bg-amber-600 transition-colors">
