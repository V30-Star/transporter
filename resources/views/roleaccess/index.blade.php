                ...
                <div class="form-group mb-4">
                    <table class="table table-bordered w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="px-3 py-2 font-semibold">Penamaan Perusahaan</td>
                                <td class="text-center" colspan="4"><input type="checkbox" name="permission[]" value="penamaanPerusahaan" {{ (in_array('penamaanPerusahaan', $selectedPermissions) || in_array('editPenamaanPerusahaan', $selectedPermissions)) ? 'checked' : '' }}></td>
                            </tr>
                            ...
                            <tr>
                                <td class="px-3 py-2 font-semibold">Laporan Uang Kasir</td>
                                <td class="text-center" colspan="4"><input type="checkbox" name="permission[]" value="printLaporanUangKasir" {{ in_array('printLaporanUangKasir', $selectedPermissions) ? 'checked' : '' }}></td>
                            </tr>
                            <tr>
