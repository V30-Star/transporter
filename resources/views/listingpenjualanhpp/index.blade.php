...
@section('title', 'Listing Penjualan Dengan HPP')
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full p-6">
                <div class="flex justify-between items-center border-b pb-4 mb-4">
                    <h3 class="text-xl font-bold text-gray-800">Listing Penjualan Dengan HPP</h3>
                    <button onclick="toggleModal(false)"
                        class="text-gray-400 hover:text-gray-600 text-2xl font-bold">&times;</button>
                </div>

                <form method="GET" action="{{ route('listingpenjualanhpp.print') }}" target="_blank">
                    <div class="space-y-4">
                        <div>
                            ...
                            <div>
                                ...
                                <select name="prd_from" class="select2 w-full">
                                    ...
                                    @foreach ($products as $product)
                                        <option value="{{ $product->fprdcode }}">{{ $product->fprdcode }} -
                                            {{ $product->fprdname }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
